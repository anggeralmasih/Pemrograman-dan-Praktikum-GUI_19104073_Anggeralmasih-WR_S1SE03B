...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        # Tombol Tambah
        self.tambahBttn = QtWidgets.QPushButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.tambahBttn.setFont(font)
        self.tambahBttn.setStyleSheet("background-color: rgb(223, 223, 223);")
        self.tambahBttn.setObjectName("bt_tambah")
        self.horizontalLayout.addWidget(self.tambahBttn)

        # Tombol Edit
        self.editBttn = QtWidgets.QPushButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.editBttn.setFont(font)
        self.editBttn.setStyleSheet("background-color: rgb(223, 223, 223);")
        self.editBttn.setObjectName("bt_edit")
        self.horizontalLayout.addWidget(self.editBttn)

        # Tombol Clear
        self.clearBttn = QtWidgets.QPushButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.clearBttn.setFont(font)
        self.clearBttn.setStyleSheet("background-color: rgb(223, 223, 223);")
        self.clearBttn.setObjectName("bt_clear")
        self.horizontalLayout.addWidget(self.clearBttn)

        # Tombol Keluar
        self.outBttn = QtWidgets.QPushButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.outBttn.setFont(font)
        self.outBttn.setStyleSheet("background-color: rgb(223, 223, 223);")
        self.outBttn.setObjectName("bt_keluar")
        self.horizontalLayout.addWidget(self.outBttn)
        ...
        self.outBttn.clicked.connect(Form.close)
    ...
    def retranslateUi(self, Form):
        ...
        self.tambahBttn.setText(_translate("Form", "Tambah"))
        self.editBttn.setText(_translate("Form", "Edit"))
        self.clearBttn.setText(_translate("Form", "Clear"))
        self.outBttn.setText(_translate("Form", "Exit"))
